...
class Master_JobPoster extends StatefulWidget {
  @override
  _Master_JobPosterState createState() => _Master_JobPosterState();
}

class _Master_JobPosterState extends State<Master_JobPoster> {
        ...
        setState(() {
          switch (item.title) {
            ...
            case "Search":
              ...
              break;
            case "DashBoardScreen":
              currentWidgetView = JobPosterDashBoardScreen();
              break;
          }
          selectedItem = item;
        });
