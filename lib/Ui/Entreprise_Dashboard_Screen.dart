...
class EntrepriseDashBoardScreen extends StatefulWidget {
  const EntrepriseDashBoardScreen({Key? key}) : super(key: key);
...
class _EntrepriseDashBoardScreenState extends State<EntrepriseDashBoardScreen> {
  ...
  void navigateToOffersScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => Applications()), //to edit with  actual job poster offers class name
    );
  }
  void navigateToMyWalletScreen() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => MyWalletPage()), //to edit with  actual wallet class name
    );
  }
