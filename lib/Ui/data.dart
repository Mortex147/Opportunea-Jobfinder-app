...
List<NavigationItem> getNavigationItemList() {
  return <NavigationItem>[
    NavigationItem("Jobs"),
    NavigationItem("DashBoardScreen"),
    NavigationItem("Chat"),
...
List<Application> getSavedJobs() {
  return <Application>[
    Application("Flutter UI / UX Designer", "Nike Inc.", "25secs", "40",
        "assets/images/nike.png"),
    Application("Product Designer", "Google LLC", "25secs", "60",
        "assets/images/google.png"),
    Application("UI / UX Designer", "Uber Technologies Inc.", "25secs", "55",
        "assets/images/uber.png"),
    Application("Lead UI / UX Designer", "Apple Inc.", "25secs", "80",
        "assets/images/apple.png"),
    Application("Flutter UI Designer", "Amazon Inc.", "25secs", "60",
